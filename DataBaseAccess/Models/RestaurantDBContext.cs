    ...
    public partial class RestaurantDBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //                optionsBuilder.UseSqlServer("Server=DESKTOP-ORATB70;Database=food_restaurant_ver_8;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => new { e.OrderIdOrder, e.FoodIdFood })
                    .HasName("dishes_PK");
                ...
                entity.Property(e => e.FoodIdFood).HasColumnName("food_id_food");
                ...
                entity.HasOne(d => d.FoodIdFoodNavigation)
                    .WithMany(p => p.Dishes)
                    .HasForeignKey(d => d.FoodIdFood)
                    .OnDelete(DeleteBehavior.ClientSetNull)
